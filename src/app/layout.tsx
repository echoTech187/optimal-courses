...
export const metadata: Metadata = {
  title: "Optimal Bimbel - Platform Kursus Online Terbaik di Indonesia",
  description: "Optimal Untuk Negeri adalah platform edukasi yang berkomitmen untuk menyediakan akses pembelajaran berkualitas tinggi bagi semua orang. Kami percaya bahwa pendidikan adalah kunci untuk membuka potensi individu dan membangun masa depan yang lebih baik.",
};
