            ...
            <div data-carousel='{ "loadingClasses": "opacity-0", "slidesQty": { "xs": 1, "sm": 2, "md": 3, "lg": 3, "xl": 4 },  "isAutoPlay": true, "speed": 5000 ,"isInfiniteLoop": true }'
                ...
                <div className='carousel h-full' >
                    <div className='carousel-body h-full max-sm:gap-0 gap-2 text-white'>
                        <div className='carousel-slide bg-blue-600/50 backdrop-blur-md rounded-xl border border-white/20 shadow-xl h-[120px] hover:cursor-pointer'>
                            <div className='flex justify-between gap-2 p-4'>
                                <div className='flex justify-center items-center p-4'>
                                    <Icon icon="mdi:account-group" className="w-14 h-14" />
                                </div>
                                <div className='flex flex-col items-start p-4 flex-1'>
                                    <h2 className='text-2xl font-bold w-full'>219,596</h2>
                                    <p className='w-full text-sm'>Pengguna Terdaftar</p>
                                </div>
                            </div>
                        </div>
                        <div className='carousel-slide bg-blue-600/50 backdrop-blur-md rounded-xl border border-white/20 shadow-xl h-[120px] hover:cursor-pointer'>
                            <div className='flex justify-between gap-2 p-4'>
                                ...
                                <div className='flex flex-col items-start p-4 flex-1'>
                                    <h2 className='text-2xl font-bold w-full'>764,932</h2>
                                    <p className='w-full text-sm'>Try Out Terlaksana</p>
                                </div>
                            </div>
                        </div>
                        <div className='carousel-slide bg-blue-600/50 backdrop-blur-md rounded-xl border border-white/20 shadow-xl h-[120px] hover:cursor-pointer'>
                            <div className='flex justify-between gap-2 p-4'>
                                ...
                                <div className='flex flex-col items-start p-4 flex-1'>
                                    <h2 className='text-2xl font-bold w-full'>60,596</h2>
                                    <p className='w-full text-sm'>Alumni Kompeten</p>
                                </div>
                            </div>
                        </div>
                        <div className='carousel-slide bg-blue-600/50 backdrop-blur-md rounded-xl border border-white/20 shadow-xl h-[120px] hover:cursor-pointer'>
                            <div className='flex justify-between gap-2 p-4'>
                                ...
                                <div className='flex flex-col items-start p-4 flex-1'>
                                    <h2 className='text-2xl font-bold w-full '>59</h2>
                                    <p className='w-full text-sm'>Kampus MoU</p>
                                </div>
                            </div>
                        </div>
                    </div>
