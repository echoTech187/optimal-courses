    ...
    return (
        <div className="bg-gray-50" id="faqs">
            <div className="max-w-[1300px] mx-auto px-4 py-16  rounded-lg my-6">
                ...
                <div className="text-center mt-12 px-12 py-8 bg-purple-800 rounded-lg w-1/2 mx-auto text-white">
                    <h1 className="text-2xl font-semibold mb-6">Masih Punya pertanyaan terkait UKOM?</h1>
                    <a href="/faq" className="flex items-center w-fit mx-auto bg-white text-green-700 font-semibold px-6 py-3 rounded-lg hover:bg-transparent hover:text-white border-2 border-transparent hover:border-white transition-colors">
