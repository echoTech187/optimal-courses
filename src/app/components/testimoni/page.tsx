            ...
            <div data-carousel='{"currentIndex": 0, "loadingClasses": "opacity-0", "slidesQty": { "xs": 1, "md": 2, "lg":3 },  "isAutoPlay": true, "speed": 5000 ,"isInfiniteLoop": true }'
                ...
                <div className='carousel min-h-80' >
                    <div className="carousel-body h-full w-full gap-8 flex items-stretch">
                        <div className="carousel-slide w-full bg-white p-6 my-6 rounded-lg shadow-xs flex flex-col items-center text-center">
                            ...
                            <h3 className="font-bold capitalize"><span className="text-black/60">Stikes Bhakti husada Bengkulu</span> - Meci Putri Utami</h3>
                        </div>
                        <div className="carousel-slide bg-white p-6 my-6 rounded-lg shadow-xs flex flex-col items-center text-center">
                            ...
                            <h3 className="font-bold capitalize"><span className="text-black/60">Unipdu Jombang</span> - Zuliana Latifah Ari Hidawati</h3>
                        </div>
                        <div className="carousel-slide bg-white p-6 my-6 rounded-lg shadow-xs flex flex-col items-center text-center">
                            ...
                            <h3 className="font-bold capitalize"><span className="text-black/60 ">Stikes majapahit</span> - Lili wahyuni</h3>
                        </div>
                        <div className="carousel-slide bg-white p-6 my-6 rounded-lg shadow-xs flex flex-col items-center text-center">
                        ...
                        <div className="carousel-slide bg-white p-6 my-6 rounded-lg shadow-xs flex flex-col items-center text-center">
                            ...
                            <h3 className="font-bold capitalize"><span className="text-black/60 ">Akper Waingapu</span> - Anastasia padu lemba</h3>
                        </div>
                    </div>
                </div>
